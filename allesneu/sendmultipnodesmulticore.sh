...
do
    ...
    do
        ...
        echo "#SBATCH --job-name="$x"gegen"$x"i"$i >> single.in
        ...
        echo "" >> single.in
        echo "" >> single.in
        echo "mpirun --mca btl_openib_if_include mlx4_0 build/multinodes -o 3 -i "$i" -b 17179869184 -m 2 -w 300 -q" $q >> single.in
        echo "" >> single.in
