...
for file in *.out
    ...
    echo "  '"$file"' using (\$2):(\$5/1000000):(\$6/1000000) w yerrorbars ls 1 title 'data' axes x1y1, \\" >> "$my_var".gnuplot
    echo "  '' using (\$2):(\$5/1000000) w lines ls 1 title '' axes x1y1, \\" >> "$my_var".gnuplot
